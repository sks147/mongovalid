			...
			$jsonSchema: {
				...
				properties: {
					_id: {
						...
						description:
							'_id must be of type objectId and is required',
					},
					name: {
						bsonType: BSONType.string,
						description:
							'name must be of type string and is required',
					},
					age: {
						bsonType: BSONType.number,
						description:
							'age must be of type number and is not required',
					},
				},
			...
			$jsonSchema: {
				...
				properties: {
					...
					title: {
						bsonType: BSONType.string,
						description:
							'title must be of type string and is required',
					},
					views: {
						bsonType: BSONType.number,
						description:
							'views must be of type number and is not required',
					},
				},
				additionalProperties: false,
			},
			...
			$jsonSchema: {
				...
				properties: {
					...
					count: {
						...
						description:
							'count must be of type int and is not required',
					},
				},
				additionalProperties: false,
			},
